...
class editarController {
    ...
    public  function  __construct ( $ id ) {
        $ this -> editar = novo  Banco ();
        $ this -> criarFormulario ( $ id );
    }
     função  privada criarFormulario ( $ id ) {
...
$ editar = novo editarController ( $ id );
if ( isset ( $ _POST [ 'enviar' ])) {
    $ editar -> editarFormulario ( $ _POST [ 'nome' ], $ _POST [ 'autor' ], $ _POST [ 'quantidade' ], $ _POST [ 'preco' ], $ _POST [ 'dados' ], $ _POST [ ' flag ' ], $ _POST [ ' id ' ]);
}
?>